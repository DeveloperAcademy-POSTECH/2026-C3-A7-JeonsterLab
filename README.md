...
- Mac은 유료 다운로드 앱이며, 앱 내부 결제·구독·체험 횟수 제한 없이 편집과 내보내기를 제공합니다. iPhone/Apple Watch companion 앱은 무료입니다.
...
| Graph | Label | Folder |
| --- | --- | --- |
| ![Graph](assets/labeling_graph.png) | ![Label](assets/labeling_label.png) | ![Folder](assets/labeling_folder.png) |
